...
certificate_print_text($pdf, $x, $y + 22, 'C', 'Helvetica', 'B', 36,  "Real Estate Continuing Education");
certificate_print_text($pdf, $x, $y + 40, 'C', 'Helvetica', null, 30,  "Verifiable " . $certificate->customtext);
certificate_print_text($pdf, $x, $y + 70, 'C', 'Helvetica', null, 20,  "This is to certify that on");
certificate_print_text($pdf, $x, $y + 80, 'C', 'Helvetica', null, 20,  certificate_get_date($certificate, $certrecord, $course));
...
if ($certificate->printhours) {
    ...
    certificate_print_text($pdf, $x + 40, $y + 130, 'C', 'Helvetica', null, 14, $certificatesummary, 200);
}
