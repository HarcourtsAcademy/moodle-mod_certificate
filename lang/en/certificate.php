...
$string['typeA4_academy'] = 'A4 Academy'; /* Academy Patch #015 Add Academy Certificate Template */
$string['typeA4_arel'] = 'A4 AREL'; /* Academy Patch #016 Add AREL Certificate Template */
